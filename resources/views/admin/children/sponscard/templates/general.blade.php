@php
    ...
    $current_grade = $child->details
        ...
        ->value ?? '';
    $firstName = explode(' ', trim($child->name))[0];
@endphp
...
<div
    ...
    data-case-history="{{ $case_history }}"
>

    <!-- Title -->
    <h4 class="text-success text-center mt-1 mb-1 fw-bold">
        Be My Hero!
    </h4>
        ...
        <div class="case-history text-center mx-2">
           ...
           <p>
            ...
            <div class="card-message">
                Be part of <b>{{ $child->name }}</b>'s brighter future today!
            </div>
...
function downloadCard(button)
{
    ...
    .catch(function(error) {
        ...
        alert('Unable to download the card.');
